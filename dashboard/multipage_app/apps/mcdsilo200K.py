...
edp_fig = px.scatter(df_comb, 
                     ...
                     title=f'Memcached-Silo 200K QPS')
        
layout = html.Div([
    html.H3('Memcached-Silo QPS 200K'),
    dcc.Link('Home', href='/'),
    html.Br(),
    
    dcc.Graph(
        id='mcdsilo20-edp-scatter',
        figure = edp_fig,
        style={'display': 'inline-block'},
    ),   

    html.Div(id='mcdsilo20-my-output'),
    html.P('SYS = ', style={'display': 'inline-block'}),
    dcc.Dropdown(id='mcdsilo20-sys-dd',
                 options=[
    ...
    dcc.Dropdown(id='mcdsilo20-i-dd',                 
                 options=[
                     {'label': 0, 'value': 0},
                     {'label': 1, 'value': 1},
                     {'label': 2, 'value': 2},
    ...
    dcc.Dropdown(id='mcdsilo20-itr-dd',
                 options=[
                     {'label': 50, 'value': 50},
                     {'label': 100, 'value': 100},
                     {'label': 200, 'value': 200},
    ...
    dcc.Dropdown(id='mcdsilo20-dvfs-dd',
                 options=[
    ...
    dcc.Dropdown(id='mcdsilo20-rapl-dd',
                 options=[
                     {'label': 135, 'value': 135},
                     {'label': 95, 'value': 95},
                     {'label': 75, 'value': 75},
    ...
    dcc.Dropdown(id='mcdsilo20-core-dd',
                 options=[
                     {'label': '0', 'value': 0},
                     {'label': '1', 'value': 1},
                     {'label': '2', 'value': 2},
    ...
    html.Button(id='mcdsilo20-btn', children='Update Plots', n_clicks=0),
    html.Br(),
    dcc.Graph(
        id='mcdsilo20-timeline-1',
        style={'display': 'inline-block'},
    ),
    
    dcc.Graph(
        id='mcdsilo20-timeline-2',
        style={'display': 'inline-block'},
    ),
    
    dcc.Graph(
        id='mcdsilo20-timeline-3',
        style={'display': 'inline-block'},
    ),

    dcc.Graph(
        id='mcdsilo20-timeline-4',
        style={'display': 'inline-block'},
    ),

    dcc.Graph(
        id='mcdsilo20-timeline-5',
        style={'display': 'inline-block'},
    ),
    
    dcc.Graph(
        id='mcdsilo20-timeline-6',
        style={'display': 'inline-block'},
    ),

    dcc.Graph(
        id='mcdsilo20-timeline-7',
        style={'display': 'inline-block'},
    ),

    dcc.Graph(
        id='mcdsilo20-timeline-8',
        style={'display': 'inline-block'},
    ),

    dcc.Graph(
        id='mcdsilo20-timeline-9',
        style={'display': 'inline-block'},
    ),

    dcc.Graph(
        id='mcdsilo20-timeline-10',
        style={'display': 'inline-block'},
    ),

    dcc.Graph(
        id='mcdsilo20-timeline-11',
        style={'display': 'inline-block'},
    ),

    dcc.Graph(
        id='mcdsilo20-timeline-12',
        style={'display': 'inline-block'},
    ),
    ...
    html.Div([
        dcc.Dropdown(id='mcdsilo20-xaxis-selector-1', value='time', style={'width':'60%'}, options=axis_values),
        dcc.Dropdown(id='mcdsilo20-yaxis-selector-1', value='joules', style={'width':'60%'}, options=axis_values),        
        dcc.Graph(
            id='mcdsilo20-custom-scatter-1', style={'display': 'inline-block'}
        )
    ], style={'display': 'inline-block'}),
        
    html.Div([
        dcc.Dropdown(id='mcdsilo20-xaxis-selector-2', value='time', style={'width':'60%'}, options=axis_values),
        dcc.Dropdown(id='mcdsilo20-yaxis-selector-2', value='joules', style={'width':'60%'}, options=axis_values),
        dcc.Graph(
            id='mcdsilo20-custom-scatter-2', style={'display': 'inline-block'}
        ),
    ], style={'display': 'inline-block'}),

    html.Div([
        dcc.Dropdown(id='mcdsilo20-xaxis-selector-3', value='time', style={'width':'60%'}, options=axis_values),
        dcc.Dropdown(id='mcdsilo20-yaxis-selector-3', value='joules', style={'width':'60%'}, options=axis_values),
        dcc.Graph(
            id='mcdsilo20-custom-scatter-3',
            style={'display': 'inline-block'}
        ),
    ], style={'display': 'inline-block'}),
    ...
    html.Div([
        ...
        dcc.Dropdown(id='mcdsilo20-xaxis-selector-3d-1', value='time', options=axis_values, style={'display': 'inline-block', 'width':'30%'}),
        html.P('Y = ', style={'display': 'inline-block'}),
        dcc.Dropdown(id='mcdsilo20-yaxis-selector-3d-1', value='itr', options=axis_values, style={'display': 'inline-block', 'width':'30%'}),
        html.P('Z = ', style={'display': 'inline-block'}),
        dcc.Dropdown(id='mcdsilo20-zaxis-selector-3d-1', value='joules', options=axis_values, style={'display': 'inline-block', 'width':'30%'}),
        html.Br(),
        html.P('Color = ', style={'display': 'inline-block'}),
        dcc.Dropdown(id='mcdsilo20-color-selector-3d-1', value='sys', options=axis_values, style={'display': 'inline-block', 'width':'30%'}),
        html.P('Symbol = ', style={'display': 'inline-block'}),
        dcc.Dropdown(id='mcdsilo20-symbol-selector-3d-1', value='dvfs', options=axis_values, style={'display': 'inline-block', 'width':'30%'}),
        html.P('Size = ', style={'display': 'inline-block'}),
        dcc.Dropdown(id='mcdsilo20-size-selector-3d-1', value='rapl', options=axis_values, style={'display': 'inline-block', 'width':'30%'}),
        html.Br(),
        dcc.Graph(
            id='mcdsilo20-custom-scatter3d-1',
            style={'display': 'inline-block'},
        ),
    ]),
    ...
    html.Div([
        html.P('X = ', style={'display': 'inline-block'}),
        dcc.Dropdown(id='mcdsilo20-xaxis-selector-3d-2', value='time', options=axis_values, style={'display': 'inline-block', 'width':'30%'}),
        html.P('Y = ', style={'display': 'inline-block'}),
        dcc.Dropdown(id='mcdsilo20-yaxis-selector-3d-2', value='itr', options=axis_values, style={'display': 'inline-block', 'width':'30%'}),
        html.P('Z = ', style={'display': 'inline-block'}),
        dcc.Dropdown(id='mcdsilo20-zaxis-selector-3d-2', value='joules', options=axis_values, style={'display': 'inline-block', 'width':'30%'}),
        html.Br(),
        html.P('Color = ', style={'display': 'inline-block'}),
        dcc.Dropdown(id='mcdsilo20-color-selector-3d-2', value='sys', options=axis_values, style={'display': 'inline-block', 'width':'30%'}),
        html.P('Symbol = ', style={'display': 'inline-block'}),
        dcc.Dropdown(id='mcdsilo20-symbol-selector-3d-2', value='dvfs', options=axis_values, style={'display': 'inline-block', 'width':'30%'}),
        html.P('Size = ', style={'display': 'inline-block'}),
        dcc.Dropdown(id='mcdsilo20-size-selector-3d-2', value='rapl', options=axis_values, style={'display': 'inline-block', 'width':'30%'}),
        html.Br(),
        dcc.Graph(
            id='mcdsilo20-custom-scatter3d-2',
            style={'display': 'inline-block'},
        ),
    ])
...
@app.callback(
    Output('mcdsilo20-i-dd', 'value'),
    Output('mcdsilo20-itr-dd', 'value'),
    Output('mcdsilo20-rapl-dd', 'value'),
    Output('mcdsilo20-dvfs-dd', 'value'),
    Output('mcdsilo20-core-dd', 'value'),
    Output('mcdsilo20-sys-dd', 'value'),
    [Input('mcdsilo20-edp-scatter', 'clickData')]
)
...
@app.callback(
#    Output('mcdsilo20-my-output', 'children'),
    Output('mcdsilo20-timeline-1', 'figure'),
    Output('mcdsilo20-timeline-2', 'figure'),
    Output('mcdsilo20-timeline-3', 'figure'),
    Output('mcdsilo20-timeline-4', 'figure'),
    Output('mcdsilo20-timeline-5', 'figure'),
    Output('mcdsilo20-timeline-6', 'figure'),
    Output('mcdsilo20-timeline-7', 'figure'),
    Output('mcdsilo20-timeline-8', 'figure'),
    Output('mcdsilo20-timeline-9', 'figure'),
    Output('mcdsilo20-timeline-10', 'figure'),
    [Input('mcdsilo20-btn', 'n_clicks')],
    [State('mcdsilo20-i-dd', 'value'),
     State('mcdsilo20-itr-dd', 'value'),
     State('mcdsilo20-rapl-dd', 'value'),
     State('mcdsilo20-dvfs-dd', 'value'),
     State('mcdsilo20-core-dd', 'value'),
     State('mcdsilo20-sys-dd', 'value')]
)
...
for i in range(1, 4):
    @app.callback(
        Output('mcdsilo20-custom-scatter-'+str(i), 'figure'),
        [Input('mcdsilo20-xaxis-selector-'+str(i), 'value'),
         Input('mcdsilo20-yaxis-selector-'+str(i), 'value')]
    )
...
for i in range(1, 2):
    @app.callback(
        Output('mcdsilo20-custom-scatter3d-'+str(i), 'figure'),
        [Input('mcdsilo20-xaxis-selector-3d-'+str(i), 'value'),
         Input('mcdsilo20-yaxis-selector-3d-'+str(i), 'value'),
         Input('mcdsilo20-zaxis-selector-3d-'+str(i), 'value'),
         Input('mcdsilo20-color-selector-3d-'+str(i), 'value'),
         Input('mcdsilo20-symbol-selector-3d-'+str(i), 'value'),
         Input('mcdsilo20-size-selector-3d-'+str(i), 'value')]
    )
