class Locations:
    aggregate_files_loc = '../analysis'

    netpipe_logs_loc = '/don-scratch/asplos_2021_datasets/netpipe'
    netpipe_linux_subfolder = 'linux/linux'
    netpipe_ebbrt_subfolder = 'ebbrt/ebbrt'

    nodejs_logs_loc = '/don-scratch/asplos_2021_datasets/node'
    nodejs_linux_subfolder = 'linux/linux'
    nodejs_ebbrt_subfolder = 'ebbrt/ebbrt'

    mcd_logs_loc = '/don-scratch/asplos_2021_datasets/mcd'
    mcd_linux_subfolder = 'linux/linux'
    mcd_ebbrt_subfolder = 'ebbrt/ebbrt'

    mcdsilo_logs_loc = '/don-scratch/asplos_2021_datasets/mcdsilo'
